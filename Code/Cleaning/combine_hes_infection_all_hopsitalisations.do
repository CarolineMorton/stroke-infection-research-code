...
save hospitalisation_collapsed, replace
...
drop _m
merge 1:1 patid using hosp_collapsed
drop _m
save all_infections_hosp, replace
...
merge 1:1 patid using all_infections_hosp
drop _m
...
save post_stroke_dementia_dataset_final_hosp, replace
